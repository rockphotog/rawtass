...
def add_files_to_xcode_project():
    ...
    print(
        f"FileBrowser.swift - File ID: {file_browser_file_id}, Build ID: {file_browser_build_id}"
    )
    print(
        f"ImageViewerPane.swift - File ID: {image_viewer_file_id}, Build ID: {image_viewer_build_id}"
    )
    ...
    sources_pattern = (
        r"(A1B2C3D4E5F6071829AB0015 /\* RawImageViewer\.swift in Sources \*/,)"
    )
